...
module ed_synth_emif_ph2_inst_altera_merlin_axi_slave_ni_1990_gtyc2oq
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    ed_synth_emif_ph2_inst_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1990_jvifrbq #(
        .SYMBOLS_PER_BEAT    (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       ed_synth_emif_ph2_inst_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1990_ccry3ii #(
             .SYMBOLS_PER_BEAT (1),
