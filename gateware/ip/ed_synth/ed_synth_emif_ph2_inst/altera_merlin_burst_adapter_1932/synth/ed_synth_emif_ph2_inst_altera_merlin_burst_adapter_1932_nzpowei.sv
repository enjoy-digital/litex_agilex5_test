...
// parameterization.
// -----------------------------------------------------
module ed_synth_emif_ph2_inst_altera_merlin_burst_adapter_1932_nzpowei 
#(
    parameter 
...
(
    ...
    generate if (COMPRESSED_READ_SUPPORT == 0) begin : altera_merlin_burst_adapter_uncompressed_only
        ...
        if(PIPE_INPUTS == 1) begin: pipe_inputs
            ed_synth_emif_ph2_inst_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1932_44l46wq # (
                .SYMBOLS_PER_BEAT (1),
